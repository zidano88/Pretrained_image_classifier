...
# DATE CREATED: 2nd of november, 2019                                
# REVISED DATE: 
...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:     
        ...
        model_label1 = model_label.lower()
        #model_label = model_label.split("_")
        model_label2 = model_label1.strip()
        
        #edited
        #results_dic[[key][1]] = model_label
        #
        truth = results_dic[key][0]
        if truth in model_label2:
